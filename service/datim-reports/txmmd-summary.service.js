...
const txmmdReportSections = require('../../app/reporting-framework/json-reports/tx-reports/tx-mmd/tx-mmd-report-indicators.json');
const txmmdReportPatientListCols = require('../../app/reporting-framework/json-reports/tx-reports/tx-ml/tx-ml-report-patient-list-cols.json');

const etlHelpers = require('../../etl-helpers.js');

export class TXMMDSummaryReportService extends MultiDatasetPatientlistReport {
          ...
          super.generateReport(additionalParams).then((results) => {
            if (additionalParams && additionalParams.type === 'patient-list') {
              ...
              resolve({
                ...
                result: finalResult,
                sectionDefinitions: txmmdReportSections,
    ...
    return new Promise((resolve, reject) => {
      super
        ...
        .then((results) => {
          ...
          results['patientListCols'] = txmmdReportPatientListCols;
