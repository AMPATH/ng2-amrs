...
const pmtctrriReportSections = require('../../app/reporting-framework/json-reports/rri/pmtct-rri-framework.json');
const pmtctrriReportPatientListCols = require('../../app/reporting-framework/json-reports/rri/pmtct_rri_patient_list_template.json');

const etlHelpers = require('../../etl-helpers.js');

export class PmtctRriSummaryService extends MultiDatasetPatientlistReport {
    ...
    return new Promise((resolve, reject) => {
      super
        ...
        .then((results) => {
          ...
          results['patientListCols'] = pmtctrriReportPatientListCols;
