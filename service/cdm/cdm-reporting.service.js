        ...
        return new Promise(function (resolve, reject) {
            ...
            Promise.join(report.generateReport(),
                (results) => {                    
                    ...
                    processors.convertCdmConceptIdToName(["dm_meds","htn_meds","problems","dm_status","htn_status"],results,'').then(function(processedResult){
        ...
        return new Promise(function (resolve, reject) {
            ...
            Promise.join(report.generateReport(),
                (results) => {
                    results.result=results.results.results;
                    delete results['results'];
                    processors.convertCdmConceptIdToName(["dm_meds","htn_meds"],results,'').then(function(processedResult){
                      processors.cdmMedicationChange(processedResult).then(function(_processedResult) {
