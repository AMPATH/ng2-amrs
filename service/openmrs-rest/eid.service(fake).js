...
module.exports = function () {
  ...
  function postAllObsToAMRS(payload, patientUuId) {
    ...
    if (payload.viralLoad.length > 0) {
      _.each(payload.viralLoad, function (viralLoadPayload) {
        ...
        if (valid == 1) {
          promisesViralLoadlAll.push(module.exports.generateAndPostLabObsPayload(restConsumablePayload,
            patientUuId, module.exports.convertViralLoadPayloadToRestConsumableObs));
        }
        else if (valid == 0) {
          promisesViralLoadlAll.push(module.exports.generateAndPostLabObsPayload(viralLoadPayload,
            patientUuId, module.exports.convertViralLoadWithLessThanToRestConsumableObs));
        }
        else {
          var restConsumablePayload = module.exports.convertViralLoadExceptionToRestConsumableObs(viralLoadPayload, patientUuId);
          promisesViralLoadlAll.push(module.exports.generateAndPostLabObsPayload(viralLoadPayload,
            patientUuId, module.exports.convertViralLoadExceptionToRestConsumableObs));
        }
      });
    }
    if (payload.cd4Panel.length > 0) {
      _.each(payload.cd4Panel, function (cd4Payload) {
        ...
        if (cd4PanelHasValidData) {
          ...
          promisesCd4All.push(module.exports.generateAndPostLabObsPayload(cd4Data,
            patientUuId, module.exports.convertCD4PayloadTORestConsumableObs));
        }
        if (cd4PanelHasErrors) {
          var cd4Exceptions = module.exports.generateCd4Exceptions(cd4Payload);
          promisesCd4All.push(module.exports.generateAndPostLabObsPayload(cd4Exceptions,
            patientUuId, module.exports.convertCD4ExceptionTORestConsumableObs));
        }
      });
    }
    if (payload.pcr.length > 0) {
      _.each(payload.pcr, function (pcrPayload) {
        promisesDnaPcrAll.push(
          module.exports.generateAndPostLabObsPayload(pcrPayload,
            patientUuId, module.exports.convertDNAPCRPayloadTORestConsumableObs)
        );
      });
    }
    return new Promise(function (resolve, reject) {
  ...
  return {
    ...
    generateAndPostLabObsPayload: generateAndPostLabObsPayload
  }
} ();
