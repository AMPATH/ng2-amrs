...
export class LungCancerTreatmentSummary {
    ...
    getAggregateReport(reportParams) {
        return new Promise(function (resolve, reject) {
            ...
            if (reportParams.requestParams.period === 'daily') {
                report = new BaseMysqlReport('lungCancerTreatmentDailySummaryAggregate', reportParams.requestParams);
            } else if (reportParams.requestParams.period === 'monthly') {
                report = new BaseMysqlReport('lungCancerTreatmentMonthlySummaryAggregate', reportParams.requestParams);
            }
    ...
    getPatientListReport(reportParams) {
        ...
        let report = new PatientlistMysqlReport('lungCancerTreatmentMonthlySummaryAggregate', reportParams);
        ...
        return new Promise(function (resolve, reject) {
            ...
            Promise.join(report.generatePatientListReport(indicators),
                (results) => {
                    oncologyReportsService.getPatientListCols(reportParams.indicators,'1a5a9a8d-f4a8-4c48-b63a-22f84530b4b9')
