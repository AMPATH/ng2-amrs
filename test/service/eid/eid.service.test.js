...
describe('EID SERVICES TESTS', function () {
    ...
    describe('Testing eid service layer', function () {
        ...
        it('should create the right payload object when generatePayload service is called with a raw DNAPCR Client Payload',
            function (done) {
                var options = {
                    params: {
                        lab: 'ampath'
                ...
                eidService.generatePayload(options.payload,
                    function (res) {
                        payload=res;
                        done();
                    }, function (res) {
