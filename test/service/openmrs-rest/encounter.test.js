  ...
  describe('Open MRS Encounter Service Unit Tests', function() {
    ...
    var dummyResponse = {
      'results': [{
        ...
        'links': [{
          'uri': testRestUrl + '/ws/rest/v1/encounter/bf218490-1691-11df-97a5-7038c432aabf',
          'rel': 'self'
        }]
      }]
    }
    ...
    it('getPatientEncounters Should make a call to retrieve a list of ' +
       'encounters for a patient', function() {
      var params = {
