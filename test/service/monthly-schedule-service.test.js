        ...
        let runReportStub = sinon.stub(dao, 'runReport', (reportParams) => {
            return new Promise((resolve, reject) => {
                ...
                if (reportParams['reportName'] === 'has-not-returned-report') {
                    ...
                    resolve({ "startIndex": 0, "size": 1, "result": [{ "d": "2017-02-01", "has_not_returned": 3 }] });
                }
