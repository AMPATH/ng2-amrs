...
describe('PROGRAM VISITTYPES SERVICE:', function () {
    ...
    it('should load program visit types service',
        function () {
            expect(pVisitTypes).to.be.defined;
        });


    it('should determine whether a visit type is allowed for a given patient',
        function () {
            var scope = {
    ...
    it('should seperate allowed visit and disallowed visit types' +
        ...
        function () {
            ...
            var expected = {
                allowed: [
                    programsConfig.visitTypes[0]
                ],
                disallowed: [
                    programsConfig.visitTypes[1]
                ]
            };

            var actual = pVisitTypes.
                separateAllowedDisallowedVisitTypes(scope, programsConfig.visitTypes);

            expect(actual).to.deep.equal(expected);
        });

    it('should fetch the visit types for a given patient, program, and intended visit location',
        function (done) {
            ...
            pVisitTypes.getPatientVisitTypes(patientUuid, programUuid, programEnrollmentUuid,
                intendedLocationUuid, programConfig)
