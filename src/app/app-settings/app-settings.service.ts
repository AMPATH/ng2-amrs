...
export class AppSettingsService {
  ...
  constructor(private localStorageService: LocalStorageService) {
    ...
    const cachedAmrsIdGenUrl = localStorageService.getItem(AppSettingsService.AMRSIDGEN_SERVER_KEY);
  ...
  public addAmrsIdGenUrl(url: string): void {
    ...
    this.localStorageService.setObject(AppSettingsService.AMRSIDGEN_SERVER_LIST_KEY,
