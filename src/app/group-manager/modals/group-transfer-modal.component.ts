...
@Component({
    ...
    <div class="modal-body">
      <h5> {{patient.person.display}} is enrolled in {{groupToUnenroll.cohort.name}} under
        DC program.
        Would you like to <b>unenroll</b> from <b>{{groupToUnenroll.cohort.name}}</b> and
         <b>enroll</b> in <b>{{groupToEnroll.name}}</b>?</h5>
    </div>
