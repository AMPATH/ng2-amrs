...
xdescribe("SurgeResourceService()", () => {
  ...
  it("should retrieve surge weekly report data when given correct parameters", () => {
    ...
    const req = http.expectOne(
      mockUrl +
        "surge-report?year_week=201905&locationUuids=08feae7c-1352-11df-a1f1-0026b9348838"
    );
  ...
  it("should retrieve surge weekly patient list when given correct param", () => {
    ...
    service
      .getSurgeWeeklyPatientList(mockWeeklyParams)
  ...
  it("should retrieve daily surge report data when given correct paramters", () => {
    service
      .getSurgeDailyReport(mockDayParams)
      .subscribe((response: Response) => {
        expect(response).toBeDefined();
      });
    ...
    const req = http.expectOne(
      mockUrl +
        "surge-daily-report?_date=2019-01-02&locationUuids=08feae7c-1352-11df-a1f1-0026b9348838"
    );
    expect(req.request.method).toBe("GET");
  ...
  it("should retrive surge daily report patient list", () => {
    ...
    service
      .getSurgeDailyReportPatientList(mockDailyPatientListParams)
      .subscribe((response: Response) => {
        expect(response).toBeDefined();
    ...
    const req = http.expectOne(
      mockUrl +
        "surge-daily-report-patient-list?indicators=visit_type" +
