...
describe('Service :  Data Entry Statictics Service', () => {
    ...
    it('Should return a list of data statistics types ',
        inject([DataEntryStatisticsService],
            (d: DataEntryStatisticsService) => {
                    let statTypes = d.getDataEntryStatisticsTypes();
                    expect(statTypes).toBe(JSON.stringify(mockDataEntryTypes));
            })
    );
