...
@Injectable()
export class CdmSummaryIndicatorsResourceService {
    constructor(protected http: Http, protected appSettingsService: AppSettingsService,
                private cacheService: DataCacheService) { }

    public getUrl(): string {
        return this.appSettingsService.getEtlRestbaseurl().trim() + `cdm-summary-indicators`;
    }

    public getPatientListUrl(): string {
        return this.appSettingsService.getEtlRestbaseurl().trim()
            + `cdm-summary-indicators/patient-list`;
    }
    ...
    public getCdmSummaryIndicatorsReport(params) {
    ...
    public getCdmSummaryIndicatorsPatientList(params) {
        let urlParams = this.getUrlRequestParams(params);
