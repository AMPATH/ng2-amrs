...
describe("CdmSummaryService Unit Tests", () => {
  ...
  it("should be injected with all dependencies", inject(
    [CdmSummaryResourceService],
    (cdmSummaryResourceService: CdmSummaryResourceService) =>
      expect(cdmSummaryResourceService).toBeTruthy()
  ));

  it("should return a list of Cdm summary record", () => {
    const cdmSummaryResourceService: CdmSummaryResourceService = TestBed.get(
      CdmSummaryResourceService
    );
    ...
    cdmSummaryResourceService
      .getCdmSummary(patientUuid, startIndex, limit)
      .subscribe((data) => {
