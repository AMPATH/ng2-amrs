...
export class PatientReferralResourceService {
  ...
  public getUrl(): string {
    return (
      this.appSettingsService.getEtlRestbaseurl().trim() + "patient-referrals"
    );
  }
  ...
  public getUrlRequestParams(params): HttpParams {
    ...
    if (
      ...
      params.notificationStatus !== "undefined"
    ) {
  ...
  public updateReferralNotificationStatus(payload) {
    ...
    const url =
      this.getReferralNotificationUrl() + "/" + payload.patient_referral_id;
  ...
  public getReferralByLocationUuid(
    locationUuid: string,
    enrollmentUud?: string
  ) {
    const url =
      this.getReferralLocationUrl() + "/" + locationUuid + "/" + enrollmentUud;
