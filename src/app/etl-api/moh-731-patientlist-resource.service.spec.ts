...
describe('Service: Moh731PatientListResourceService', () => {
  ...
  it('should call the API with correct url params when getMoh731PatientListReport() is called', fakeAsync(() => {
    service
    ...
    const req = httpMock.expectOne(
      'base-url/MOH-731-report/patient-list?' +
  ...
  it('should call the correct API url given a set of params', fakeAsync(() => {
    service
      .getMoh731PatientListReport({
        startIndex: 0,
        isLegacy: true,
  ...
  it('should return a report with correct structure from the API call', fakeAsync(() => {
    service
      .getMoh731PatientListReport({
        startIndex: 0,
        isLegacy: true,
