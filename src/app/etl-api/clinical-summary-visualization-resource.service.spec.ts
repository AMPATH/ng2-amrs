...
describe('ClinicalSummaryVisualizationResourceService Tests', () => {
  ...
  it('clinical summary visualization resourceService resource methods should be defined', inject(
    [ClinicalSummaryVisualizationResourceService],
    (s: ClinicalSummaryVisualizationResourceService) => {
  ...
  it('should return report urlRequest parameters', inject(
    [ClinicalSummaryVisualizationResourceService],
    (s: ClinicalSummaryVisualizationResourceService) => {
  ...
  it('should return Hiv Comparative Overview Report', inject(
    [ClinicalSummaryVisualizationResourceService, HttpTestingController],
    (
      s: ClinicalSummaryVisualizationResourceService,
  ...
  it('should return Hiv Comparative Overview Report Patient List', inject(
    [ClinicalSummaryVisualizationResourceService],
    (s: ClinicalSummaryVisualizationResourceService) => {
      s.getHivComparativeOverviewPatientList(reportParams).subscribe(
        (result) => {
          expect(result).toBeDefined();
  ...
  it('should return clinical-art-overview Report', inject(
    [ClinicalSummaryVisualizationResourceService],
    (s: ClinicalSummaryVisualizationResourceService) => {
  ...
  it('should return clinical-art-overview Report Patient List', inject(
    [ClinicalSummaryVisualizationResourceService],
    (s: ClinicalSummaryVisualizationResourceService) => {
  ...
  it('should return clinical-patient-care-status-overview Report', inject(
    [ClinicalSummaryVisualizationResourceService],
    (s: ClinicalSummaryVisualizationResourceService) => {
  ...
  it('should return clinical-patient-care-status-overview Report Patient List', inject(
    [ClinicalSummaryVisualizationResourceService],
    (s: ClinicalSummaryVisualizationResourceService) => {
