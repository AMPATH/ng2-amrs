...
export class PatientCreationService {
  ...
  constructor(
    private resouceService: PatientResourceService,
  ...
  private identifierTypeFormat() {
    return [
      ...
      {
        label: "AMPATH Staff PF Number",
        format: "^AM-\\d{4,5}$",
        checkdigit: null,
        val: "c700c468-57b4-45c5-8912-318770c8856d",
      },
      {
        label: "Anticoagulation Clinic Number",
        format: "^AC-\\d{4,5}$",
        checkdigit: null,
