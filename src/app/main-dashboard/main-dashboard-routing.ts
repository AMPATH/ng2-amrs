...
import { RegistersModule } from '../registers-dashboard/registers.module';
...
export function registersModule() {
...
export const dashboardRoutes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadChildren: '../registers-dashboard/registers.module#RegistersModule'
      }
    ]
  }
];
