...
describe('Model: Encounter', () => {
    ...
    it('should wrap openmrs encounter for display correctly', () => {
        ...
        expect(wrappedEnconter.encounterDatetime).
            toEqual(new Date(existingEncounter.encounterDatetime));
    ...
    it('should generate a new encounters new payload correctly', () => {
        ...
        expect(newPayload.encounterDatetime).
            toEqual('2016-01-01T00:00:00.000Z'); // TODO: check dates
