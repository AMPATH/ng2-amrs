...
export interface ShrDoseQuantity {
  value: number;
  unit: string;
  code: string;
}
export interface ShrDoseAndRate {
  doseQuantity: ShrDoseQuantity;
}
export interface ShrDosageTiming {
  repeat: {
    duration: number;
    durationUnit: string;
  };
...
export interface ShrRequest {
  method: string;
  url: string;
}

export interface ShrBasedOn {
  type: string;
  identifier: ShrIdentifier;
}
...
export interface ShrMedicationRequest {
