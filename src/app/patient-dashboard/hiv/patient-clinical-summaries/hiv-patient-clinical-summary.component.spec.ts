...
import { FakeDefaultUserPropertiesFactory } from '../../common/formentry/mock/default-user-properties-factory.service.mock';
...
describe('Component: HivPatientClinicalSummaryComponent', () => {
  ...
  it('should generate pdf when the component initializes', (done) => {
    const component: HivPatientClinicalSummaryComponent = TestBed.get(
      HivPatientClinicalSummaryComponent
    );
  ...
  it('should fetch patient summaries from server when the component initializes', (done) => {
    const component: HivPatientClinicalSummaryComponent = TestBed.get(
      HivPatientClinicalSummaryComponent
    );
    const hivPatientClinicalSummaryService: HivPatientClinicalSummaryService =
  ...
  it('should generate pdf when the component generatePdf() is invoked', (done) => {
    const component: HivPatientClinicalSummaryComponent = TestBed.get(
      HivPatientClinicalSummaryComponent
    );
    const hivPatientClinicalSummaryService: HivPatientClinicalSummaryService =
  ...
  it('should fetch patient summaries from server when the generatePdf() is invoked', (done) => {
    const component: HivPatientClinicalSummaryComponent = TestBed.get(
      HivPatientClinicalSummaryComponent
    );
    const hivPatientClinicalSummaryService: HivPatientClinicalSummaryService =
  ...
  it('should throw an error when generatePdf fails', (done) => {
    const component: HivPatientClinicalSummaryComponent = TestBed.get(
      HivPatientClinicalSummaryComponent
    );
    const hivPatientClinicalSummaryService: HivPatientClinicalSummaryService =
    ...
    spyOn(hivPatientClinicalSummaryService, 'generatePdf').and.callFake(
      (uuid) => {
  ...
  it('should throw an error when fetchPatientSummary encounters an error', (done) => {
    const component: HivPatientClinicalSummaryComponent = TestBed.get(
      HivPatientClinicalSummaryComponent
    );
    const hivPatientClinicalSummaryService: HivPatientClinicalSummaryService =
  ...
  it('should navigate to the next page when nextPage is invoked', (done) => {
    const component: HivPatientClinicalSummaryComponent = TestBed.get(
      HivPatientClinicalSummaryComponent
    );
  ...
  it('should navigate to the previous page when prevPage() is invoked', (done) => {
    const component: HivPatientClinicalSummaryComponent = TestBed.get(
      HivPatientClinicalSummaryComponent
    );
