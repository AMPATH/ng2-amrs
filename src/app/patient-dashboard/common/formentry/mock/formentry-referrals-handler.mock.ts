...
export let programVisitConfigs = {
    ...
    visitTypes: [
      {
        ...
        allowedIf:
          'age >= 20 && programLocation === intendedVisitLocationUuid && isFirstAMPATHHIVVisit',
        // tslint:disable-next-line: max-line-length
        message:
          'Patient has to be 20yrs and above, in the location he enrolled into the HIV Care and Treatment program and there must not be prior clinical encounter.',
        encounterTypes: [
          {
      ...
      },
      {
        ...
        // tslint:disable-next-line: max-line-length
        allowedIf:
          'age >= 20 && programLocation === intendedVisitLocationUuid && !isFirstAMPATHHIVVisit && previousHIVClinicallocation !== programLocation',
        // tslint:disable-next-line: max-line-length
        message:
          "Patient has to be 20yrs and above , patient's program location should be equal to the last HIV clinical encounter location and should not be the first clinical encounter",
        encounterTypes: [
          {
            uuid: 'a44ad5e2-b3ec-42e7-8cfa-8ba3dbcf5ed7',
            display: 'HIVTRIAGE'
      ...
      },
      {
        ...
        // tslint:disable-next-line: max-line-length
        message:
          'Patient has to be 20yrs and above, in the location he enrolled into the HIV Care and Treatment program  and there must be a prior clinical encounter.',
        encounterTypes: [
          {
            uuid: 'a44ad5e2-b3ec-42e7-8cfa-8ba3dbcf5ed7',
            display: 'HIVTRIAGE'
      ...
      },
      {
        ...
        allowedIf:
          'age <= 14 && programLocation === intendedVisitLocationUuid && isFirstAMPATHHIVVisit',
        // tslint:disable-next-line: max-line-length
        message:
          'Patient has to be 14rs and below ,in the location he enrolled into the HIV Care and Treatment program and there must not be prior clinical encounter.',
        encounterTypes: [
          {
            uuid: 'a44ad5e2-b3ec-42e7-8cfa-8ba3dbcf5ed7',
            display: 'HIVTRIAGE'
      ...
      },
      {
        ...
        // tslint:disable-next-line: max-line-length
        allowedIf:
          'age <= 14 && programLocation === intendedVisitLocationUuid && !isFirstAMPATHHIVVisit && previousHIVClinicallocation !== programLocation',
        encounterTypes: [
          {
            uuid: 'a44ad5e2-b3ec-42e7-8cfa-8ba3dbcf5ed7',
            display: 'HIVTRIAGE'
      ...
      },
      {
        ...
        // tslint:disable-next-line: max-line-length
        message:
          'Patient has to be 14yrs and below, in the location enrolled into the HIV Care and Treatment program and it must not be the initial clinical encounter.',
        encounterTypes: [
          {
            uuid: 'a44ad5e2-b3ec-42e7-8cfa-8ba3dbcf5ed7',
            display: 'HIVTRIAGE'
      ...
      },
      {
        ...
        allowedIf:
          'age >= 10 && age <= 24 && programLocation === intendedVisitLocationUuid && isFirstAMPATHHIVVisit',
        // tslint:disable-next-line: max-line-length
        message:
          'Patient has to between 10 and 24yrs , in the location he enrolled into the HIV Care and Treatment program and must not have a prior clinical encounter',
        encounterTypes: [
          {
            uuid: 'a44ad5e2-b3ec-42e7-8cfa-8ba3dbcf5ed7',
            display: 'HIVTRIAGE'
      ...
      },
      {
        ...
        // tslint:disable-next-line: max-line-length
        allowedIf:
          'age >= 10 && age <= 24 && programLocation === intendedVisitLocationUuid && !isFirstAMPATHHIVVisit && previousHIVClinicallocation !== programLocation',
        // tslint:disable-next-line: max-line-length
        message:
          'Patient has to between 10 and 24yrs , in the location he enrolled into the HIV Care and Treatment program, must have a prior clinical encounter.The program location should be different from the previous encounter location',
        encounterTypes: [
          {
            uuid: 'a44ad5e2-b3ec-42e7-8cfa-8ba3dbcf5ed7',
            display: 'HIVTRIAGE'
      ...
      },
      {
        ...
        // tslint:disable-next-line: max-line-length
        message:
          'Patient has to between 10 and 24yrs , in the location he enrolled into the HIV Care and Treatment program and must have a prior clinical encounter',
        encounterTypes: [
          {
            uuid: 'a44ad5e2-b3ec-42e7-8cfa-8ba3dbcf5ed7',
            display: 'HIVTRIAGE'
      ...
      },
      {
        ...
        allowedIf:
          'programLocation !== intendedVisitLocationUuid && !isFirstAMPATHHIVVisit',
        // tslint:disable-next-line: max-line-length
        message:
          'Patient has to be in a different location from location he was enrolled into HIV care and treatment program and must have a prior clinical encounter',
        encounterTypes: [
          {
            uuid: 'a44ad5e2-b3ec-42e7-8cfa-8ba3dbcf5ed7',
            display: 'HIVTRIAGE'
  ...
  '781d897a-1359-11df-a1f1-0026b9348838': {
    ...
    visitTypes: [
      ...
      },
      {
        ...
        allowedIf:
          'age >= 0 && age <= 2 && programLocation === intendedVisitLocationUuid && isFirstAMPATHHIVVisit',
  ...
  'f7793d42-11ac-4cfd-9b35-e0a21a7a7c31': {
    ...
    incompatibleWith: ['781d85b0-1359-11df-a1f1-0026b9348838'],
    visitTypes: [
      {
  ...
  '334c9e98-173f-4454-a8ce-f80b20b7fdf0': {
    ...
    visitTypes: [
      ...
      },
      {
        ...
        allowedIf:
          'programLocation === intendedVisitLocationUuid && !qualifiesForStandardVisit',
        message:
          'Patient has to be in the location he enrolled into the HIV Care and Treatment program ',
        encounterTypes: [
          {
            uuid: 'a44ad5e2-b3ec-42e7-8cfa-8ba3dbcf5ed7',
            display: 'HIVTRIAGE'
      ...
      },
      {
        ...
        allowedIf:
          'age >= 10 && programLocation === intendedVisitLocationUuid && !isFirstAMPATHHIVVisit',
        encounterTypes: [
          {
            uuid: 'a44ad5e2-b3ec-42e7-8cfa-8ba3dbcf5ed7',
            display: 'HIVTRIAGE'
