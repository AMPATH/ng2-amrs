...
import { testReferralInfo, testProgramVisitConfig, testUnenrollmentPayload,
  testPatient2, testReferralPayload, programVisitConfigs } from './formentry-referrals-handler.mock';
...
describe('Service: FormentryReferralsHandler', () => {
  ...
  it('should refer to differentiated care program when referal is selected', (done) => {
