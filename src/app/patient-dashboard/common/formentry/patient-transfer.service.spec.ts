...
​
  appSettingsServiceSpy = jasmine.createSpyObj('AppSettingsService', ['getEtlRestbaseurl']);
  deptProgramsConfigServiceSpy = jasmine.createSpyObj('DepartmentProgramsConfigService',
    ['getDartmentProgramsConfig']);
  localStorageServiceSpy = jasmine.createSpyObj('LocalStorageService', ['getItem', 'setItem']);
  selectDepartmentServiceSpy = jasmine.createSpyObj('SelectDepartmentService', ['getUserSetDepartment']);
​
  beforeEach(() => {
...
​
    service = new PatientTransferService(
      selectDepartmentServiceSpy
    );
  });
​
  afterEach(() => {
