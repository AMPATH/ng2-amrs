    ...
    encounters: [
      {
        ...
        encounterObj: {
          ...
          visit: {
            uuid: 'bbacffb1-e607-43bc-85ec-5dae2fea3a96',
            display:
              'RETURN HIV CLINIC VISIT @ Location-195 - 09/08/2016 11:03',
            auditInfo: {
              creator: {
                uuid: 'db99b4fc-833d-4857-91d3-3f4736b46b50',
                display: 'username-165060',
...
describe('Component : Visit-Encounters', () => {
  ...
  beforeEach(() => {
    ...
    const patientEncounterService = fixture.debugElement.injector.get(
      PatientEncounterService
    );
  ...
  it('should render encounter types in desc order', async(() => {
  ...
  it('should generate a new visits array based on encounters', async(() => {
