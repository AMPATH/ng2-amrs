...
describe('FormVisitTypeSearchComponent test', () => {
    ...
    let formListServiceStub: FormListService;
    ...
    it('should subscribe PatientProgramResourceService getAllProgramVisitConfigs method', () => {
        spyOn(patientProgramResourceServiceStub, 'getAllProgramVisitConfigs').and.returnValue(of({staus: 'okay', res: 'program visits configs'}));
        component.getProgramsVisitConfig();
