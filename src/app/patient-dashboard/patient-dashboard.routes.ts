...
import { ProgramManagerContainerComponent } from '../program-manager/container/program-manager-container.component';
import { ProgramSummaryComponent } from '../program-manager/program-summary/program-summary.component';
...
import { DrugOrdersComponent } from './common/drug-orders/drug-orders.component';
    ...
    children: [
      {
        ...
        canDeactivate: [PatientDashboardGuard],
        resolve: {
          patient: PatientDashboardResolver
        },
        children: [
          {
            path: 'general/:program/landing-page',
            component: GeneralLandingPageComponent
          },
          {
            path: ':programClass/:program',
            redirectTo: ':programClass/:program/landing-page',
            pathMatch: 'full'
          },
          {
          ...
          {
            path: ':programClass/:program/hiv-summary',
            component: HivSummaryComponent
          },
          {
            path: ':programClass/:program/cdm-summary',
            component: CdmSummaryComponent
          },
          {
            path: ':programClass/:program/oncology-summary',
            component: OncologySummaryComponent
          },
          {
          ...
          {
            path: ':programClass/:program/lab-data-summary',
            component: LabDataSummaryComponent
          },
          {
            path: ':programClass/:program/patient-imaging',
            component: PatientImagingComponent
          },
          {
            path: ':programClass/:program/patient-gene-xpert-images',
            component: GeneXpertImagesComponent
          },
          {
            path: ':programClass/:program/lab-orders',
            component: LabOrdersComponent
          },
          {
            path: ':programClass/:program/clinical-notes',
            component: ClinicalNotesComponent
          },
          {
            path: ':programClass/:program/visit',
            component: TodayVisitsComponent
          },
          {
          ...
          {
            path: ':programClass/:program/drug-orders',
            component: DrugOrdersComponent
          }
        ]
      }
    ]
