...
xdescribe("VisitResourceService", () => {
  ...
  describe("get visit by uuid", () => {
    ...
    it("should call the right endpoint", async(() => {
      ...
      const req = httpMock.expectOne(
        "https://amrs.ampath.or.ke:8443/amrs/ws/rest/v1/visit/uuid?v="
      );
    ...
    it("should call the right endpoint", async(() => {
      service
        .getPatientVisits({
          patientUuid: "uuid",
          v:
            "(uuid,patient:(uuid,uuid),visitType:(uuid,name)" +
  ...
  describe("get patient visits types", () => {
      ...
      results: [
        {
          ...
          description:
            "This is the first visit a patient makes to the HIV clinic.",
        },
        {
          uuid: "d4ac2aa5-2899-42fb-b08a-d40161815b48",
          name: "RETURN HIV CLINIC VISIT",
          description:
            "This is the subsequent visit a patient makes to the HIV clinic.",
        },
      ],
    };
    beforeEach(() => {
    ...
    it("should call the right endpoint", async(() => {
      ...
      const req = httpMock.expectOne(
        `${appSettingsService.getOpenmrsRestbaseurl().trim()}visittype`
      );
