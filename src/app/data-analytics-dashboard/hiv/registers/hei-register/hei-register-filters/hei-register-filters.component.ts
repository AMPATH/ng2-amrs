...
@Component({
  selector: 'app-hei-register-filters',
  templateUrl: './hei-register-filters.component.html',
  styleUrls: ['./hei-register-filters.component.css']
})
export class HeiRegisterFiltersComponent implements OnInit {
