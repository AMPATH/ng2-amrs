...
@Component({
  selector: 'app-moh731-register',
  templateUrl: './moh731-register.component.html',
  styleUrls: ['./moh731-register.component.css']
})
export class Moh731RegisterComponent implements OnInit {
  @Output()
  public params: any;
  ...
  public reportName = 'MOH 731 REGISTER';
