...
@Component({
  selector: 'app-moh731-filters',
  templateUrl: './moh731-filters.component.html',
  styleUrls: ['./moh731-filters.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class Moh731FiltersComponent implements OnInit {
