...
import { TxMmdReportBaseComponent } from 'src/app/hiv-care-lib/tx-mmd-report/tx-mmd-report-base/tx-mmd-report-base.component';

@Component({
  selector: 'app-tx-mmd-report-base',
  templateUrl:
    './../../../hiv-care-lib/tx-mmd-report/tx-mmd-report-base/tx-mmd-report-base.component.html'
})
export class TxMmdReportComponent
  extends TxMmdReportBaseComponent
  implements OnInit {
  ...
  constructor(
    ...
    super(router, route, txMmdResourceService);
  }
