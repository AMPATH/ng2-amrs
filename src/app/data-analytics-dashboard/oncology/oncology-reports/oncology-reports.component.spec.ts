...
const getReportsSpy = getOncologyReportsService.getOncologyReports.and.returnValue(
...
describe("Component: Oncology Reports", () => {
  ...
  beforeEach((done) => {
    TestBed.configureTestingModule({
      ...
      declarations: [OncologyReportsComponent],
      providers: [
      ...
      .then(() => {
        ...
        oncologyReportService = fixture.debugElement.injector.get(
          OncologyReportService
        );
