...
@Component({
  selector: 'facility-referral-report-tabular',
  templateUrl: 'facility-referral-report-tabular.component.html',
  // changeDetection: ChangeDetectionStrategy.OnPush
})

export class FacilityReferralTabularComponent implements OnInit {
