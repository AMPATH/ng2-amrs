...
export class FacilityReferralPatientListComponent implements OnInit {
  ...
  constructor(public route: ActivatedRoute,
              ...
              public resourceService: CdmIndicatorsResourceService,
  ...
  public generatePatientListReport() {
    this.isLoading = true;
    this.resourceService.getCdmIndicatorsPatientList({
