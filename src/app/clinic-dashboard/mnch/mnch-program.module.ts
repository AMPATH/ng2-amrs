...
import { mnchProgramRouting } from './mnch-program.routes';
import { DateTimePickerModule } from '@ampath-kenya/ngx-openmrs-formentry';
import { EtlApi } from '../../etl-api/etl-api.module';
import { HivCareLibModule } from '../../hiv-care-lib/hiv-care-lib.module';
import { DataListsModule } from '../../shared/data-lists/data-lists.module';
import { MNCHDailyScheduleComponent } from './daily-schedule/daily-schedule.component';
...
@NgModule({
  ...
  exports: [],
  declarations: [MNCHDailyScheduleComponent, DailyScheduleClinicFlowComponent],
  providers: []
})
export class MNCHModule {}
