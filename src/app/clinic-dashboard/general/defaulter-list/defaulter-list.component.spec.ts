...
describe("Component: DefaulterListComponent", () => {
  let component,
    defaulterResource: DefaulterListResourceService,
    route,
    router,
  ...
  it("should create an instance", () => {
    ...
    const appointmentsComponent = new DefaulterListComponent(
      clinicDashBoardCacheService,
      defaulterResource,
      route,
      router
  ...
  it("should format list data  when formatDefaulterListData method is called", (done) => {
    ...
    expect(formatted[0].last_appointment).toEqual(
      "19-09-2016 ADULTNONCLINICALMEDICATION"
    );
    ...
    expect(formatted[0].encounter_type_name).toEqual(
      testData[0].encounter_type_name
    );
  ...
  it(
    "should cache defaulter list parameters when  cacheDefaulterListParam " +
      "method is called",
    (done) => {
  ...
  it(
    "should load defaulter list with cached parameters when  loadDefaulterListFromCachedParams " +
      "method is called",
    (done) => {
  ...
  it(
    "should get date without time part when  getDatePart " + "method is called",
    (done) => {
  ...
  it(
    "should return null when  getDatePart " +
      "method is called with null values",
    (done) => {
      spyOn(component, "getDatePart").and.callThrough();
  ...
  it(
    "should get cached defaulter list parameters when  getCachedDefaulterListParam " +
      "method is called",
    (done) => {
      spyOn(component, "getCachedDefaulterListParam").and.callThrough();
      const params = component.getCachedDefaulterListParam(
        "defaulterListParam"
      );
  ...
  it("should fetch defaulter list when getDefaulterList is called", (done) => {
    ...
    router = TestBed.get(Router);
    const components = new DefaulterListComponent(
      clinicDashBoardCacheService,
      defaulterResource,
      activatedRoute,
      router
