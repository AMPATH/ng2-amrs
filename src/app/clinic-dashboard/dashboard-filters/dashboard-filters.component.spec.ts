...
import {
  HivCareComparativeService
} from
  '../clinical-summary-visualization/hiv-care-comparative-overview/hiv-care-comparative.service';
import {
...
export class FakeHivCareComparativeService {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      providers: [
        ...
        {
          provide: HivCareComparativeService,
          useFactory: () => new FakeHivCareComparativeService()
        },
        {
