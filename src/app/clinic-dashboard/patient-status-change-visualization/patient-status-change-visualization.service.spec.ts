  ...
  it('return column definations when generateColumDefinations() is called',
    inject([PatientStatuChangeVisualizationService],
      (s: PatientStatuChangeVisualizationService) => {
        let definations = s.generateColumnDefinitions({});
      ...
      (s: PatientStatuChangeVisualizationService) => {
        ...
        let columnOptions = {
          ...
          'LTFU': {
            ...
            tooltip: 'A patient is LTFU if it has been greater than 90 days' +
            ' from the RTC date within the given reporting period ',
            pinned: false,
            patient_list: true,
            width: 160
          ...
          'transfer_out_patients': {
            ...
            tooltip: 'These are patients ever transferr' +
            'ed to other Ampath or NON Ampath facility',
            pinned: false,
            width: 200,
            patient_list: true
          },
          'self_disengaged_patients': {
            ...
            tooltip: 'These are patients ever disengaged ' +
            'out of care by themselves',
            pinned: false,
            width: 200,
            patient_list: true
          },
          'cumulative_deficit': {
            ...
            tooltip: 'Number of patients who are neither d' +
            'ead, negative, self-disengaged, active nor LTFU',
            pinned: false,
            width: 160,
            patient_list: true,
            hide: false
