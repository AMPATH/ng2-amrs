...
describe('PatientStatusChangeVisualizationService', () => {
  ...
  const mockActivatedRoute = {
    params: {
      subscribe: jasmine
        .createSpy('subscribe')
        .and.returnValue(Observable.of({ id: 1 }))
    }
  };
  beforeEach(() => {
  ...
  it('return column definations when generateColumDefinations() is called', inject(
    [PatientStatuChangeVisualizationService],
    (s: PatientStatuChangeVisualizationService) => {
      const definations = s.generateColumnDefinitions(
        'cumulativeAnalysis',
        'active_return',
        []
      );
  ...
  it('return chart definations  when generateChart() is called', inject(
    [PatientStatuChangeVisualizationService],
    (s: PatientStatuChangeVisualizationService) => {
      const data = [
        {
