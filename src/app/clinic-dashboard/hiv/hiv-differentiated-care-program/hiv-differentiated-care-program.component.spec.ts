...
import { HivDifferentiatedCarePatientListComponent } from './hiv-differentiated-care-program-patient-list/hiv-differentiated-care-patient-list.component';
...
describe('HivDifferentiatedCareComponent Tests', () => {
  ...
  it('should have required properties', () => {
    ...
    expect(component.title).toBe(
      'Differentiated Service Delivery Program Reports'
    );
  });
});
