...
import { RegistersRoutesFactory } from './register-side-nav-routes.factory';
import { RoutesProviderService } from '../../../shared/dynamic-route/route-config-provider.service';
import { LocalStorageService } from 'src/app/utils/local-storage.service';

describe('Registers Routes Factory:', () => {
  ...
  it('should inject client routes service', inject(
    [RegistersRoutesFactory],
    (s: RegistersRoutesFactory) => {
      expect(s).toBeTruthy();
    }
  ));
  ...
  it('should have related programs shared routes', () => {
    ...
    const service = TestBed.get(RegistersRoutesFactory);
