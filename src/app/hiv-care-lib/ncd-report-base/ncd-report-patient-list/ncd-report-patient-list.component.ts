...
@Component({
  selector: 'app-ncd-report-patient-list',
  templateUrl: './ncd-report-patient-list.component.html',
  styleUrls: ['./ncd-report-patient-list.component.css']
})
export class NcdReportPatientListComponent implements OnInit {
  public params: any;
  ...
  private getPatientList(params: any) {
    this.ncdReportService.getNCDPatientList(params).subscribe((data) => {
