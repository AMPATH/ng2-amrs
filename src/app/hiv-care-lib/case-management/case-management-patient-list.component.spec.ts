...
describe('CaseManagementPatientListComponent', () => {
  ...
  it('load case managers and patient info correctly', () => {
    spyOn(caseManagementResourceService, 'getCaseManagers').and.returnValue(Observable.of(mockCaseManager));
    ...
    expect(component.attributeUuid).toEqual(mockChangeCaseManager.attribute_uuid);
  });
});
