...
describe("Moh731ReportBaseComponent:", () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      declarations: [Moh731ReportBaseComponent, Moh731ReportFiltersComponent],
      providers: [
  ...
  it("should be injected", () => {
    ...
    expect(
      fixture.componentInstance.moh731Resource instanceof
        Moh731ResourceServiceMock
    ).toBe(true);
  });

  it("should generate moh report using paramaters supplied", (done) => {
    const fakeReply: any = {
      result: [
        {
          location: "ampath",
    ...
    const mohSpy = spyOn(service, "getMoh731Report").and.callFake(
      (locationUuids, startDate, endDate, isLegacyReport, isAggregated) => {
  ...
  it("should report errors when generating moh report fails", (done) => {
    comp = fixture.componentInstance;
    const service = fixture.componentInstance.moh731Resource;
    const mohSpy = spyOn(service, "getMoh731Report").and.callFake(
      (locationUuids, startDate, endDate, isLegacyReport, isAggregated) => {
