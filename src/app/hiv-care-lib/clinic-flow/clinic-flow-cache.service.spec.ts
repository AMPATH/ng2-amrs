...
describe("ClinicFlowCacheService Unit Tests", () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      declarations: [],
      providers: [ClinicFlowCacheService],
    });
  });
  ...
  it("should be defined", inject(
    ...
    (s: ClinicFlowCacheService) => {
      expect(s).toBeTruthy();
    }
  ));

  it("should set selected location when setSelectedLocation is invoked with location uuid ", (done) => {
  ...
  it("should set selected date when setSelectedDate is invoked with date ", (done) => {
    service = TestBed.get(ClinicFlowCacheService);
  ...
  it("should set ClinicFlowData when setClinicFlowData is invoked with data ", (done) => {
    service = TestBed.get(ClinicFlowCacheService);
  ...
  it("should format data when formatData is invoked with data ", (done) => {
    service = TestBed.get(ClinicFlowCacheService);
    let formattedData = service.formatData([
      { names: "test name 1" },
      { names: "test name 1" },
    ]);
  ...
  it("should return columns when getClinicFlowColumns is invoked ", (done) => {
    service = TestBed.get(ClinicFlowCacheService);
    const columns = service.getClinicFlowColumns();
    expect(columns.length).toEqual(9);
    done();
  });
  it("should cache Last Clinic Flow Selected Date ", (done) => {
    service = TestBed.get(ClinicFlowCacheService);
