...
import { PatientsRequiringVLReportFiltersComponent } from "./patients-requiring-vl-report-filters.component";
import { PatientsRequiringVLResourceServiceMock } from "../../etl-api/patients-requiring-vl-resource.service.mock";
import { PatientsRequiringVLResourceService } from "../../etl-api/patients-requiring-vl-resource.service";
...
describe("PatientsRequiringVLBaseComponent:", () => {
  ...
  it("should be injected", () => {
    ...
    expect(
      fixture.componentInstance.patientsRequiringVLResourceService instanceof
        PatientsRequiringVLResourceServiceMock
    ).toBe(true);
  });

  it("should generate patients requiring vl patient list using paramaters supplied", (done) => {
    const fakeReply: any = {
      result: [
        {
          person_id: 800302,
    ...
    comp = fixture.componentInstance;
    const service =
      fixture.componentInstance.patientsRequiringVLResourceService;
    const hivSpy = spyOn(service, "getPatientList").and.callFake(
  ...
  it("should report errors when generating patients requiring vl patient list fails", (done) => {
    comp = fixture.componentInstance;
    const service =
      fixture.componentInstance.patientsRequiringVLResourceService;
    const hivSpy = spyOn(service, "getPatientList").and.callFake(
