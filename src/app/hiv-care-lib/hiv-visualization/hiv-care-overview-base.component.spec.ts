...
import { ClinicalVisualizationResourceServiceMock } from '../../etl-api/clinical-summary-visualization.service.mock';
...
describe('HivCareComparativeOverviewBaseComponent:', () => {
  ...
  it('should be injected', () => {
    ...
    expect(
      fixture.componentInstance.visualizationResourceService instanceof
        ClinicalVisualizationResourceServiceMock
    ).toBe(true);
  });

  it('should generate hiv care comparative report using paramaters supplied', (done) => {
    const fakeReply: any = {
      result: [
        {
  ...
  it('should report errors when generating hiv care comparative report fails', (done) => {
    comp = fixture.componentInstance;
    const service = fixture.componentInstance.visualizationResourceService;
    const hivSpy = spyOn(
      service,
