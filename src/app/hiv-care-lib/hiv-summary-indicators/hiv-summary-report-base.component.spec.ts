...
import { HivSummaryIndicatorsResourceServiceMock } from "../../etl-api/hiv-summary-indicators.service.mock";
...
describe("HivSummaryIndicatorBaseComponent:", () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      declarations: [HivSummaryIndicatorBaseComponent, ReportFiltersComponent],
      providers: [
        {
  ...
  it("should be injected", () => {
    ...
    expect(
      fixture.componentInstance.hivSummaryIndicatorsResourceService instanceof
        HivSummaryIndicatorsResourceServiceMock
    ).toBe(true);
  });

  it("should generate hiv summary report using paramaters supplied", (done) => {
    const fakeReply: any = {
      result: [
        {
    ...
    comp = fixture.componentInstance;
    const service =
      fixture.componentInstance.hivSummaryIndicatorsResourceService;
    const hivSpy = spyOn(service, "getHivSummaryIndicatorsReport").and.callFake(
      ({
        endDate: endDate,
        gender: gender,
        startDate: startDate,
  ...
  it("should report errors when generating hiv summary report fails", (done) => {
    comp = fixture.componentInstance;
    const service =
      fixture.componentInstance.hivSummaryIndicatorsResourceService;
    const hivSpy = spyOn(service, "getHivSummaryIndicatorsReport").and.callFake(
