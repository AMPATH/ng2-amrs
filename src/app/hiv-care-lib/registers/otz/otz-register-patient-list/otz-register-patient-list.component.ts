...
@Component({
  selector: 'app-otz-register-patient-list',
  templateUrl: './otz-register-patient-list.component.html',
  styleUrls: ['./otz-register-patient-list.component.css']
})
export class OTZRegisterPatientListComponent implements OnInit {
  public title = 'OTZ Monthly Register';
  public params: any;
