...
@Component({
  selector: 'app-otz-register-filter',
  templateUrl: './otz-register-filter.component.html',
  styleUrls: ['./otz-register-filter.component.css']
})
export class OTZRegisterFilterComponent implements OnInit, OnChanges {
  ...
  public errorMessage = '';
  public reportName = 'otz-monthly-register-report';
  public dates: any;
  public age: any;
