...
import { HivMonthlySummaryIndicatorBaseComponent } from "./hiv-monthly-summary-report-base";
import { HivMonthlySummaryIndicatorsResourceService } from "../../etl-api/hiv-monthly-summary-indicators-resource.service";
import { HivMonthlyIndicatorsResServiceMock } from "../../etl-api/hiv-summary-monthly-indicators.service.mock";
...
describe("HivMonthlySummaryIndicatorBaseComponent:", () => {
  ...
  it("should be injected", () => {
    ...
    expect(
      fixture.componentInstance.hivIndicatorsResourceService instanceof
        HivMonthlyIndicatorsResServiceMock
    ).toBe(true);
  });

  it("should generate hiv summary monthly report using paramaters supplied", (done) => {
    const fakeReply: any = {
      result: [
        {
  ...
  it("should report errors when generating hiv summary monthly report fails", (done) => {
    comp = fixture.componentInstance;
    const service = fixture.componentInstance.hivIndicatorsResourceService;
    const hivSpy = spyOn(
      service,
