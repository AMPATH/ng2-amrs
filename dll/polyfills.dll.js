...
__webpack_require__(86)(Number, 'Number', function (iterated) {
  this._l = +iterated;
  this._i = 0;
}, function () {
  var i = this._i++;
...
var $export = __webpack_require__(1);
var $re = __webpack_require__(121)(/[\\^$*+?.()|[\]{}]/g, '\\$&');
...
var $export = __webpack_require__(1);
var $re = __webpack_require__(121)(/&(?:amp|lt|gt|quot|apos);/g, {
  '&amp;': '&',
  '&lt;': '<',
  '&gt;': '>',
  '&quot;': '"',
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(24)(proto, TO_PRIMITIVE, __webpack_require__(228));
...
$export($export.S + $export.F * !__webpack_require__(11), 'Object', { defineProperties: __webpack_require__(159) });
