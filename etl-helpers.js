  ...
  return {
    ...
    getConceptName: function getConceptName(code) {
      ...
      var concepts = {
        ...
        6543: 'MELANOMA',
        7420: 'HIGH GRADE SQUAMOUS INTRAEPITHELIAL LESION',
        7422: 'ADENOCARCINOMA',
        ...
        9593: 'FRIABLE TISSUE',
        6971: 'POSSIBLE',
        11772: 'YELLOW STAINING LESION',
        7417: 'ATYPICAL SQUAMOUS CELLS OF UNDETERMINED SIGNIFICANCE',
        7418: 'ATYPICAL GLANDULAR CELLS OF UNDETERMINED SIGNIFICANCE',
        7419: 'LOW GRADE SQUAMOUS INTRAEPITHELIAL LESION',
        7420: 'HIGH GRADE SQUAMOUS INTRAEPITHELIAL LESION',
        7421: 'SQUAMOUS CELL CARCINOMA, NOT OTHERWISE SPECIFIED',
        10055: 'INVASIVE CANCER'
      };
    ...
    getContraceptiveMethod: function getContraceptiveMethod(str) {
      if (str === null || str === undefined)
        return { concept: 1107, name: 'NONE', period: null };
      var contraceptives = [
        ...
        {
          concept: 6218,
          name: 'COMBINED HORMONE ORAL CONTRACEPTIVE PILL',
          period: 'Short term'
        },
        ...
        {
          concept: 5841,
          name: 'HERBAL TRADITIONAL MEDICATIONS',
          period: 'Short term'
        },
        ...
        {
          concept: 5274,
          name: 'FAMILY PLANNING VIA ORAL CONTRACEPTIVE PILLS',
          period: 'Short term'
        },
        ...
        {
          concept: 9510,
          name: '3-YEAR CONTRACEPTIVE IMPLANT',
          period: 'Long term'
        },
        {
          concept: 9511,
          name: '5-YEAR CONTRACEPTIVE IMPLANT',
          period: 'Long term'
        },
        ...
        {
          concept: 9735,
          name: 'HORMONAL INTRAUTERINE DEVICE',
          period: 'Long term'
        },
        {
          concept: 10956,
          name: 'CONTRACEPTION METHOD UNDECIDED',
          period: null
        },
        {
          concept: 10817,
          name: 'NORPLANT(IMPLANTABLE CONTRACEPTIVE)',
          period: 'Long term'
        }
      ];
      ...
      if (contraceptiveMethod === 0 || typeof contraceptiveMethod != 'object')
        return { concept: str, name: 'UNKNOWN', period: null };
