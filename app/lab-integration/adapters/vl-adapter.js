...
export class VLAdapter extends LabAdapter {
  ...
  mapResult(result) {
    ...
    if (valid === 1) {
      ...
      return this.payloadFormatter.convertViralLoadWithLessThanToRestConsumableObs(result, this.patientUuid);

    }
    else if (valid === 2) {
      return this.payloadFormatter.convertViralLoadExceptionToRestConsumableObs(result, this.patientUuid);
    }
  }
}