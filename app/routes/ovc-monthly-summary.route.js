...
import { OvcMonthlySummary } from '../ovc-report/ovc-monthly-summary.service';
...
const routes = [
    ...
    config: {
      ...
      handler: function (request, reply) {
        preRequest.resolveLocationIdsToLocationUuids(request, function () {
          ...
          let service = new OvcMonthlySummary(
            'ovcReport',
  ...
  },
  {
    ...
    config: {
      ...
      description:
        'Get patient list for ovc monthly summary report of the location and month provided',
